...
{{-- create an a tag to go racipe curl_file_create route--}}
        <a href="{{ route('recipes.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-boldn py-2 px-4 rounded-full">
           Create Racipe 
        </a>
            ...
            <div class="w-full max-w-sm m-2">
                <div class="bg-white border-2 border-gray-400 rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <a href="{{ route('recipes.show',['recipe'=>$recipe->id])}}" class="inline-block bg-red-500 rounded-full px-3 py-1 text-sm font-semibold hover:bg-red-600 text-white mr-2">
                            View Details
                        </a>
